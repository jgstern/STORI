...
my $hitDir="/nv/hp10/jstern7/scratch/universal120312/hits";            #directory containing taxon-taxon blast results
...
my $getParentTaxaPath = "/nv/hp10/jstern7/STORI3/getParentTaxa.pl";

my $blastTemp = "/tmp/jstern7"; #in a few lines we are going to copy the relevant data
