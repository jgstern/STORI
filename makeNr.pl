...
$projectDir = "/nv/hp10/jstern7/scratch/universal120312"; 
$hitDir = $projectDir . "/hits";

#get taxa list
$taxaFile = "/nv/hp10/jstern7/STORI3/taxids_GIs_02062013.txt";   #a list of taxids

$makeblastdbPath="/nv/hp10/jstern7/STORI3/makeblastdb";  #path to the blast+ program makeblastdb
$blastDirPath = $projectDir . "/blast";

$nrdbLoc = "/nv/hp10/jstern7/STORI3/bp_nrdb_SHA.pl";
